...
$subscriptionID = 'fef973de-017d-49f7-9098-1f644064f90d' #Microsoft Azure Sponsorship
$TenantID = 'e09d9473-1a06-4717-98c1-528067eab3a4' #Canada Computing Azure AD Tenant
$AccountID = 'Admin-cci@fgchealth.com'
$AppDisplayname = 'CCI_PSAutomation_SPO_1'
